...
- Building Decision Tree algorithm without using any pre-existing machine learning library.
  ...
  - I have to use a basic dataset from Kaggle just to demonstrate that my decision tree algorithm works very well on both Categorical data as well as Numerical continuos data.
